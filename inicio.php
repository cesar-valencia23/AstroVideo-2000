...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
    	 ...
    	 <div class="footer-copyright full-reset all-tittles">Bienvenido ASTRO VIDEO 2000</div>

        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles"><center><font size="10" face="Algerian">PELICULAS</font></center></h1>
            </div>
        </div>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/cine.jpg" alt="user" class="img-responsive center-box" style="max-width: 110px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <p>Hola bienvenido a tu pagina de renta de peliculas, en la cual nos enfocamos 
			en brindarte entretenimiento de primera calidad en los diferentes formatos que manejamos, gracias por ser parte de nosotros
	<p style=" text-align:center;"> ASTRO VIDEO 2000 </P>
</p>
                </div>
            </div>
        </div>
...
<br>
<a href="espera.php">
<img src="assets/img/alien.png" alt="Biblioteca" class="img-responsive center-box" style="width:70%;">
</a>
<br>
<br>
</div>
...
<br>
<a href="espera.php">
<img src="assets/img/transformers.png" alt="Biblioteca" class="img-responsive center-box" style="width:70%;">
</a>
<br>
<br>
</div>
...
<br>
<a href="espera.php">
<img src="assets/img/logan.png" alt="Biblioteca" class="img-responsive center-box" style="width:70%;">
</a>
<br>
<br>
</div>
...
<br>
<a href="espera.php">
<img src="assets/img/guerrapapas2.png" alt="Biblioteca" class="img-responsive center-box" style="width:70%;">
</a>
<br>
<br>
</div>
        ...
        <footer class="footer full-reset">
            ...
            <div class="footer-copyright full-reset all-tittles">ASTRO VIDEO 2000</div>
        </footer>
    </div>
</body>
</html>